...
con <- dbConnect(RSQLite::SQLite(), dbname="c:/users/oyeleye oluwatobi/desktop/history")
#con <- dbConnect(SQLite(), dbname = 'c:/users/oyeleye oluwatobi/appdata/local/google/chrome/user data/default/history')
